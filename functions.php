...
/** Uncomment below line if you need to build ACF blocks  */
...
include_once get_template_directory() . '/includes/functions-general.php';
...
/**
 * Implement styles and js.
 */
function frost_enqueue_style_sheet()
{
	wp_enqueue_style('gpd-css', get_template_directory_uri() . '/style.css');
	...
	wp_enqueue_script('gpd-js', get_template_directory_uri() . '/assets/js/custom.js', array('jquery'), '1.8.1', true);
...
function frost_register_block_styles()
{
	...
	$block_styles = array(
		...
		'core/list' => array(
			...
			'check-list' => __('Check', 'frost'),
			'numbered-list' => __('Numbered', 'frost'),
		),
		...
		'core/heading' => array(
			'green-wave-small' => __('Green Wave Small', 'frost'),
			'green-wave-medium' => __('Green Wave Medium', 'frost'),
			'green-wave-large' => __('Green Wave Large', 'frost'),
		),
	);
